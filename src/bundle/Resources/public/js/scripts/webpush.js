...
return n.d(t,"a",t),t},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n.p="",n(n.s=18)}([function(e,t){e.exports=function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}},function(e,t){function n(e,t){for(var n=0;n<t.length;n++){var r=t[n]
...
return o&&(o.onupgradeneeded=function(e){n&&n(new h(o.result,e.oldVersion,o.transaction))}),i.then((function(e){return new p(e)}))},e.deleteDb=function(e){return r(indexedDB,"deleteDatabase",[e])},Object.defineProperty(e,"__esModule",{value:!0})}(t)},function(e,t,n){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0})
var r=n(10),i={NODE_CLIENT:!1,NODE_ADMIN:!1,SDK_VERSION:"${JSCORE_VERSION}"},o=function(e,t){if(!e)throw a(t)},a=function(e){return new Error("Firebase Database ("+i.SDK_VERSION+") INTERNAL ASSERT FAILED: "+e)},s=function(e){for(var t=[],n=0,r=0;r<e.length;r++){var i=e.charCodeAt(r)
...
this.init_()
for(var n=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[],i=0;i<e.length;i+=3){var o=e[i],a=i+1<e.length,s=a?e[i+1]:0,c=i+2<e.length,u=c?e[i+2]:0,l=o>>2,f=(3&o)<<4|s>>4,d=(15&s)<<2|u>>6,h=63&u
c||(h=64,a||(d=64)),r.push(n[l],n[f],n[d],n[h])}return r.join("")},encodeString:function(e,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(e):this.encodeByteArray(s(e),t)},decodeString:function(e,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(e):function(e){for(var t=[],n=0,r=0;n<e.length;){var i=e[n++]
...
function d(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}var h=function(e){function t(n,r){var i=e.call(this,r)||this
return i.code=n,i.name="FirebaseError",Object.setPrototypeOf(i,t.prototype),Error.captureStackTrace&&Error.captureStackTrace(i,p.prototype.create),i}return r.__extends(t,e),t}(Error),p=function(){function e(e,t,n){this.service=e,this.serviceName=t,this.errors=n}return e.prototype.create=function(e){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n]
for(var r=t[0]||{},i=this.service+"/"+e,o=this.errors[e],a=o?v(o,r):"Error",s=this.serviceName+": "+a+" ("+i+").",c=new h(i,s),u=0,l=Object.keys(r);u<l.length;u++){var f=l[u]
...
return i+=r+" argument "}t.CONSTANTS=i,t.Deferred=f,t.ErrorFactory=p,t.FirebaseError=h,t.Sha1=m,t.assert=o,t.assertionError=a,t.async=function(e,t){return function(){for(var n=[],r=0;r<arguments.length;r++)n[r]=arguments[r]
...
if(r<t?i="at least "+t:r>n&&(i=0===n?"none":"no more than "+n),i)throw new Error(e+" failed: Was called with "+r+(1===r?" argument.":" arguments.")+" Expects "+i+".")},t.validateCallback=function(e,t,n,r){if((!r||n)&&"function"!=typeof n)throw new Error(S(e,t,r)+"must be a valid function.")},t.validateContextObject=function(e,t,n,r){if((!r||n)&&("object"!=typeof n||null===n))throw new Error(S(e,t,r)+"must be a valid context object.")},t.validateNamespace=function(e,t,n,r){if((!r||n)&&"string"!=typeof n)throw new Error(S(e,t,r)+"must be a valid firebase namespace.")}}).call(this,n(9))},function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
var r,i,o=n(8),a=n(3),s=n(6),c=n(12),u=((r={})["no-app"]="No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()",r["bad-app-name"]="Illegal App name: '{$appName}",r["duplicate-app"]="Firebase App named '{$appName}' already exists",r["app-deleted"]="Firebase App named '{$appName}' already deleted",r["invalid-app-argument"]="firebase.{$appName}() takes either no argument or a Firebase App instance.",r),l=new a.ErrorFactory("app","Firebase",u),f="@firebase/app",d=((i={})[f]="fire-core",i["@firebase/analytics"]="fire-analytics",i["@firebase/auth"]="fire-auth",i["@firebase/database"]="fire-rtdb",i["@firebase/functions"]="fire-fn",i["@firebase/installations"]="fire-iid",i["@firebase/messaging"]="fire-fcm",i["@firebase/performance"]="fire-perf",i["@firebase/remote-config"]="fire-rc",i["@firebase/storage"]="fire-gcs",i["@firebase/firestore"]="fire-fst",i["fire-js"]="fire-js",i["firebase-wrapper"]="fire-js-all",i),h=new c.Logger("@firebase/app"),p=function(){function e(e,t,n){var r,i,c=this
...
if(n.has(f))return h.debug("There were multiple attempts to register component "+f+"."),"PUBLIC"===s.type?r[f]:null
...
return n.apply(this,s.multipleInstances?e:[])}}try{for(var p=o.__values(Object.keys(t)),v=p.next();!v.done;v=p.next()){var g=v.value
t[g]._addComponent(s)}}catch(e){c={error:e}}finally{try{v&&!v.done&&(u=p.return)&&u.call(p)}finally{if(c)throw c.error}}return"PUBLIC"===s.type?r[f]:null}return(r.default=r,Object.defineProperty(r,"apps",{get:function(){return Object.keys(t).map((function(e){return t[e]}))}}),i.App=e,r)}(p)
...
var m=v
!function(e,t){e.INTERNAL.registerComponent(new s.Component("platform-logger",(function(e){return new g(e)}),"PRIVATE")),e.registerVersion(f,"0.5.4",t),e.registerVersion("fire-js","")}(m),t.default=m,t.firebase=m},function(e,t,n){e.exports=n(13)},function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
var r=n(11),i=n(3),o=function(){function e(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY"}return e.prototype.setInstantiationMode=function(e){return this.instantiationMode=e,this},e.prototype.setMultipleInstances=function(e){return this.multipleInstances=e,this},e.prototype.setServiceProps=function(e){return this.serviceProps=e,this},e}(),a=function(){function e(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map}return e.prototype.get=function(e){void 0===e&&(e="[DEFAULT]")
...
t.Component=o,t.ComponentContainer=s,t.Provider=a},function(e,t){function n(e,t,n,r,i,o,a){try{var s=e[o](a),c=s.value}catch(e){return void n(e)}s.done?t(c):Promise.resolve(c).then(r,i)}e.exports=function(e){return function(){var t=this,r=arguments
...
function u(e){o.forEach((function(t){t.logLevel=e}))}},function(e,t,n){var r=function(e){"use strict"
...
function s(e,t,n,r){var i=t&&t.prototype instanceof l?t:l,o=Object.create(i.prototype),a=new S(r||[])
...
r="executing"
var l=c(e,t,n)
if("normal"===l.type){if(r=n.done?"completed":"suspendedYield",l.arg===u)continue
return{value:l.arg,done:n.done}}"throw"===l.type&&(r="completed",n.method="throw",n.arg=l.arg)}}}(e,n,a),o}function c(e,t,n){try{return{type:"normal",arg:e.call(t,n)}}catch(e){return{type:"throw",arg:e}}}e.wrap=s
var u={}
function l(){}function f(){}function d(){}var h={}
h[i]=function(){return this}
var p=Object.getPrototypeOf,v=p&&p(p(x([])))
...
return l&&"object"==typeof l&&n.call(l,"__await")?Promise.resolve(l.__await).then((function(e){t("next",e,o,a)}),(function(e){t("throw",e,o,a)})):Promise.resolve(l).then((function(e){u.value=e,o(u)}),(function(e){return t("throw",e,o,a)}))}a(s.arg)}(r,i,t,o)}))}return t=t?t.then(o,o):o()}}function m(e,t){var n=e.iterator[t.method]
...
return o.next=o}}return{next:k}}function k(){return{value:void 0,done:!0}}return f.prototype=g.constructor=d,d.constructor=f,d[a]=f.displayName="GeneratorFunction",e.isGeneratorFunction=function(e){var t="function"==typeof e&&e.constructor
return!!t&&(t===f||"GeneratorFunction"===(t.displayName||t.name))},e.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,d):(e.__proto__=d,a in e||(e[a]="GeneratorFunction")),e.prototype=Object.create(g),e},e.awrap=function(e){return{__await:e}},b(y.prototype),y.prototype[o]=function(){return this},e.AsyncIterator=y,e.async=function(t,n,r,i){var o=new y(s(t,n,r,i))
...
if(n.finallyLoc===e)return this.complete(n.completion,n.afterLoc),w(n),u}},catch:function(e){for(var t=this.tryEntries.length-1;t>=0;--t){var n=this.tryEntries[t]
if(n.tryLoc===e){var r=n.completion
if("throw"===r.type){var i=r.arg
w(n)}return i}}throw new Error("illegal catch attempt")},delegateYield:function(e,t,n){return this.delegate={iterator:x(e),resultName:t,nextLoc:n},"next"===this.method&&(this.arg=void 0),u}},e}(e.exports)
try{regeneratorRuntime=r}catch(e){Function("r","regeneratorRuntime = r")(r)}},function(e,t,n){var r=n(15),i=n(16)
...
a[t]&&e.removeChild(a[t]),a.length?e.insertBefore(o,a[t]):e.appendChild(o)}}function h(e,t,n){var r=n.css,i=n.media,o=n.sourceMap
if(i?e.setAttribute("media",i):e.removeAttribute("media"),o&&btoa&&(r+="\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(o))))," */")),e.styleSheet)e.styleSheet.cssText=r
else{for(;e.firstChild;)e.removeChild(e.firstChild)
e.appendChild(document.createTextNode(r))}}var p=null,v=0
function g(e,t){var n,r,i
if(t.singleton){var o=v++
n=p||(p=u(t)),r=d.bind(null,n,o,!1),i=d.bind(null,n,o,!0)}else n=u(t),r=h.bind(null,n,t),i=function(){!function(e){if(null===e.parentNode)return!1
...
n.r(t)
var r=n(0),i=n.n(r),o=n(1),a=n.n(o),s=n(4),c=n.n(s),u=n(6)
...
break}i[2]&&a.ops.pop(),a.trys.pop()
continue}o=t.call(e,a)}catch(e){o=[6,e],r=0}finally{n=i=0}if(5&o[0])throw o[1]
return{value:o[0]?o[1]:void 0,done:!0}}([o,s])}}}function h(e){var t="function"==typeof Symbol&&e[Symbol.iterator],n=0
return t?t.call(e):{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}}}function p(e,t){var n="function"==typeof Symbol&&e[Symbol.iterator]
if(!n)return e
var r,i,o=n.call(e),a=[]
...
return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function E(e,t){var n=t.refreshToken,r=k(e)
return r.append("Authorization",function(e){return"FIS_v2 "+e}(n)),r}function I(e){return f(this,void 0,void 0,(function(){var t
...
return d(this,(function(c){switch(c.label){case 0:return t=w(e),r=k(e),i={fid:n,authVersion:"FIS_v2",appId:e.appId,sdkVersion:"w:0.4.2"},o={method:"POST",headers:r,body:JSON.stringify(i)},[4,I((function(){return fetch(t,o)}))]
...
case 4:throw c.sent()}}))}))}function C(e){return new Promise((function(t){setTimeout(t,e)}))}function T(e){return btoa(String.fromCharCode.apply(String,function(){for(var e=[],t=0;t<arguments.length;t++)e=e.concat(p(arguments[t]))
return e}(e))).replace(/\+/g,"-").replace(/\//g,"_")}var O=/^[cdef][\w-]{21}$/
function P(){try{var e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16
var t=function(e){return T(e).substr(0,22)}(e)
return O.test(t)?t:""}catch(e){return""}}function A(e){return e.appName+"!"+e.appId}var j=new Map
function L(e,t){var n=A(e)
N(n,t),function(e,t){var n=M()
n&&n.postMessage({key:e,fid:t})
R()}(n,t)}function N(e,t){var n,r,i=j.get(e)
if(i)try{for(var o=h(i),a=o.next();!a.done;a=o.next()){(0,a.value)(t)}}catch(e){n={error:e}}finally{try{a&&!a.done&&(r=o.return)&&r.call(o)}finally{if(n)throw n.error}}}var B=null
function M(){return!B&&"BroadcastChannel"in self&&((B=new BroadcastChannel("[Firebase] FID Change")).onmessage=function(e){N(e.data.key,e.data.fid)}),B}function R(){0===j.size&&B&&(B.close(),B=null)}var F,z="firebase-installations-store",K=null
function V(){return K||(K=Object(b.openDb)("firebase-installations-database",1,(function(e){switch(e.oldVersion){case 0:e.createObjectStore(z)}}))),K}function U(e,t){return f(this,void 0,void 0,(function(){var n,r,i,o,a
return d(this,(function(s){switch(s.label){case 0:return n=A(e),[4,V()]
...
case 4:return s.sent(),a&&a.fid===t.fid||L(e,t.fid),[2,t]}}))}))}function W(e){return f(this,void 0,void 0,(function(){var t,n,r
return d(this,(function(i){switch(i.label){case 0:return t=A(e),[4,V()]
case 1:return n=i.sent(),[4,(r=n.transaction(z,"readwrite")).objectStore(z).delete(t)]
case 2:return i.sent(),[4,r.complete]
case 3:return i.sent(),[2]}}))}))}function q(e,t){return f(this,void 0,void 0,(function(){var n,r,i,o,a,s
return d(this,(function(c){switch(c.label){case 0:return n=A(e),[4,V()]
...
case 7:return c.sent(),!s||a&&a.fid===s.fid||L(e,s.fid),[2,s]}}))}))}function H(e){return f(this,void 0,void 0,(function(){var t,n,r
return d(this,(function(i){switch(i.label){case 0:return[4,q(e,(function(n){var r=function(e){return $(e||{fid:P(),registrationStatus:0})}(n),i=function(e,t){if(0===t.registrationStatus){if(!navigator.onLine){var n=Promise.reject(m.create("app-offline"))
...
case 2:return 1!==t.registrationStatus?[3,5]:[4,C(100)]
case 3:return o.sent(),[4,J(e)]
case 4:return t=o.sent(),[3,2]
case 5:return 0!==t.registrationStatus?[3,7]:[4,H(e)]
case 6:return n=o.sent(),r=n.installationEntry,(i=n.registrationPromise)?[2,i]:[2,r]
case 7:return[2,t]}}))}))}function J(e){return q(e,(function(e){if(!e)throw m.create("installation-not-found")
...
return w(e)+"/"+n+"/authTokens:generate"}(n,t),i=E(n,t),(o=r.getImmediate({optional:!0}))&&i.append("x-firebase-client",o.getPlatformInfoString()),a={installation:{sdkVersion:"w:0.4.2"}},s={method:"POST",headers:i,body:JSON.stringify(a)},[4,I((function(){return fetch(e,s)}))]
...
return d(this,(function(o){switch(o.label){case 0:return[4,q(e.appConfig,(function(r){if(!Q(r))throw m.create("not-registered")
var i=r.authToken
...
case 2:return 1!==n.authToken.requestStatus?[3,5]:[4,C(100)]
...
case 4:return[2,i]}}))}))}function Z(e){return q(e,(function(e){if(!Q(e))throw m.create("not-registered")
var t,n=e.authToken
...
return d(this,(function(n){switch(n.label){case 0:return[4,H(e)]
...
return w(e)+"/"+n}(e,t),r=E(e,t),i={method:"DELETE",headers:r},[4,I((function(){return fetch(n,i)}))]
...
r&&(r.delete(t),0===r.size&&j.delete(n),R())}(n,t)}}function re(e){return m.create("missing-app-config-values",{valueName:e})}(F=c.a).INTERNAL.registerComponent(new u.Component("installations",(function(e){var t=e.getProvider("app").getImmediate(),n={appConfig:function(e){var t,n
if(!e||!e.options)throw re("App Configuration")
if(!e.name)throw re("App Name")
try{for(var r=h(["projectId","apiKey","appId"]),i=r.next();!i.done;i=r.next()){var o=i.value
...
return d(this,(function(i){switch(i.label){case 0:return[4,H(e.appConfig)]
...
return d(this,(function(r){switch(r.label){case 0:return[4,q(t=e.appConfig,(function(e){if(!e||0!==e.registrationStatus)return e}))]
...
case 6:return[2]}}))}))}(n)},onIdChange:function(e){return ne(n,e)}}}),"PUBLIC")),F.registerVersion("@firebase/installations","0.4.2")
...
function de(e){return fe.create("missing-app-config-values",{valueName:e})}function he(e){var t=new Uint8Array(e)
return btoa(String.fromCharCode.apply(String,function(){for(var e=[],t=0;t<arguments.length;t++)e=e.concat(ue(arguments[t]))
return e}(t))).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function pe(e){return ae(this,void 0,void 0,(function(){var t,n,r=this
...
n={token:o.fcmToken,createTime:(a=o.createTime,null!=a?a:Date.now()),subscriptionOptions:{auth:o.auth,p256dh:o.p256dh,endpoint:o.endpoint,swScope:o.swScope,vapidKey:"string"==typeof o.vapidKey?o.vapidKey:he(o.vapidKey)}}}else 3===t.oldVersion?n={token:(o=i).fcmToken,createTime:o.createTime,subscriptionOptions:{auth:he(o.auth),p256dh:he(o.p256dh),endpoint:o.endpoint,swScope:o.swScope,vapidKey:he(o.vapidKey)}}:4===t.oldVersion&&(n={token:(o=i).fcmToken,createTime:o.createTime,subscriptionOptions:{auth:he(o.auth),p256dh:he(o.p256dh),endpoint:o.endpoint,swScope:o.swScope,vapidKey:he(o.vapidKey)}})
return[2]}}))}))}))]
...
case 3:return[4,pe(e.appConfig.senderId)]
...
case 1:n=c.sent(),r=Ce(t),i={method:"POST",headers:n,body:JSON.stringify(r)},c.label=2
case 2:return c.trys.push([2,5,,6]),[4,fetch(Ie(e.appConfig),i)]
...
return se(this,(function(c){switch(c.label){case 0:return[4,De(e)]
case 1:n=c.sent(),r=Ce(t.subscriptionOptions),i={method:"PATCH",headers:n,body:JSON.stringify(r)},c.label=2
case 2:return c.trys.push([2,5,,6]),[4,fetch(Ie(e.appConfig)+"/"+t.token,i)]
case 3:return[4,c.sent().json()]
case 4:return o=c.sent(),[3,6]
...
return[2,o.token]}}))}))}function Ee(e,t){return ae(this,void 0,void 0,(function(){var n,r,i,o,a
return se(this,(function(s){switch(s.label){case 0:return[4,De(e)]
case 1:n=s.sent(),r={method:"DELETE",headers:n},s.label=2
case 2:return s.trys.push([2,5,,6]),[4,fetch(Ie(e.appConfig)+"/"+t,r)]
...
case 6:return[2]}}))}))}function Ie(e){return"https://fcmregistrations.googleapis.com/v1/projects/"+e.projectId+"/registrations"}function De(e){var t=e.appConfig,n=e.installations
return ae(this,void 0,void 0,(function(){var e
return se(this,(function(r){switch(r.label){case 0:return[4,n.getToken()]
case 1:return e=r.sent(),[2,new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t.apiKey,"x-goog-firebase-installations-auth":"FIS "+e})]}}))}))}function Ce(e){var t=e.p256dh,n=e.auth,r=e.endpoint,i=e.vapidKey,o={web:{endpoint:r,auth:n,p256dh:t}}
return i!==Se&&(o.web.applicationPubKey=i),o}var Te
function Oe(e,t,n){return ae(this,void 0,void 0,(function(){var r,i,o,a
...
case 2:return i=s.sent(),o={vapidKey:n,swScope:t.scope,endpoint:r.endpoint,auth:he(r.getKey("auth")),p256dh:he(r.getKey("p256dh"))},i?[3,3]:[2,je(e,o)]
case 3:if(c=i.subscriptionOptions,l=(u=o).vapidKey===c.vapidKey,f=u.endpoint===c.endpoint,d=u.auth===c.auth,h=u.p256dh===c.p256dh,l&&f&&d&&h)return[3,8]
s.label=4
case 4:return s.trys.push([4,6,,7]),[4,Ee(e,i.token)]
...
case 9:return[2]}var c,u,l,f,d,h}))}))}function Pe(e,t){return ae(this,void 0,void 0,(function(){var n,r
return se(this,(function(i){switch(i.label){case 0:return[4,ye(e)]
case 1:return(n=i.sent())?[4,Ee(e,n.token)]:[3,4]
...
case 3:return o=a.sent(),[4,Pe(t,n)]
...
case 2:return i.sent(),[2,r.token]}}))}))}function Le(e,t){return ae(this,void 0,void 0,(function(){var n
return se(this,(function(r){switch(r.label){case 0:return[4,e.pushManager.getSubscription()]
case 1:return(n=r.sent())?[2,n]:[2,e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:t})]}}))}))}function Ne(e){return"object"==typeof e&&!!e&&"google.c.a.c_id"in e}!function(e){e.PUSH_RECEIVED="push-received",e.NOTIFICATION_CLICKED="notification-clicked"}(Te||(Te={}))
...
return[2,Oe(this.firebaseDependencies,e,this.vapidKey)]}}))}))},e.prototype.deleteToken=function(){return ae(this,void 0,void 0,(function(){var e
return se(this,(function(t){switch(t.label){case 0:return[4,this.getServiceWorkerRegistration()]
case 1:return e=t.sent(),[2,Pe(this.firebaseDependencies,e)]}}))}))},e.prototype.requestPermission=function(){return ae(this,void 0,void 0,(function(){var e
...
return se(this,(function(a){switch(a.label){case 0:return(null===(t=e.data)||void 0===t?void 0:t.firebaseMessaging)?(n=e.data.firebaseMessaging,r=n.type,i=n.payload,this.onMessageCallback&&r===Te.PUSH_RECEIVED&&this.onMessageCallback(i),Ne(o=i.data)&&"1"===o["google.c.a.e"]?[4,this.logEvent(r,o)]:[3,2]):[2]
case 1:a.sent(),a.label=2
case 2:return[2]}}))}))},e.prototype.logEvent=function(e,t){return ae(this,void 0,void 0,(function(){var n
return se(this,(function(r){switch(r.label){case 0:return n=function(e){switch(e){case Te.NOTIFICATION_CLICKED:return"notification_open"
case Te.PUSH_RECEIVED:return"notification_foreground"
...
case 1:return function(e){return e.some((function(e){return"visible"===e.visibilityState&&!e.url.startsWith("chrome-extension://")}))}(n=i.sent())?[2,Fe(n,t)]:(r=function(e){var t
if(!e||"object"!=typeof e.notification)return
var n=oe({},e.notification)
return n.data=oe(oe({},e.notification.data),((t={}).FCM_MSG=e,t)),n}(t))?[4,Ve(r)]:[3,3]
...
return se(this,(function(o){switch(o.label){case 0:return e.newSubscription?[3,2]:[4,Pe(this.firebaseDependencies,self.registration)]
case 1:return o.sent(),[2]
case 2:return[4,ye(this.firebaseDependencies)]
case 3:return i=o.sent(),[4,Pe(this.firebaseDependencies,self.registration)]
case 4:return o.sent(),[4,Oe(this.firebaseDependencies,self.registration,(r=null===(n=null===(t=i)||void 0===t?void 0:t.subscriptionOptions)||void 0===n?void 0:n.vapidKey,null!=r?r:Se))]
...
if(i)return i
return Ne(e.data)?self.location.origin:null}(r))?[4,Re(i)]:[2]):[2]
...
case 6:return o?(a=Ke(Te.NOTIFICATION_CLICKED,r),[2,o.postMessage(a)]):[2]}var c}))}))},e}()
function Re(e){return ae(this,void 0,void 0,(function(){var t,n,r,i,o,a,s
return se(this,(function(c){switch(c.label){case 0:return t=new URL(e,self.location.href).href,[4,ze()]
case 1:n=c.sent()
try{for(r=ce(n),i=r.next();!i.done;i=r.next())if(o=i.value,new URL(o.url,self.location.href).href===t)return[2,o]}catch(e){a={error:e}}finally{try{i&&!i.done&&(s=r.return)&&s.call(r)}finally{if(a)throw a.error}}return[2,null]}}))}))}function Fe(e,t){var n,r,i=Ke(Te.PUSH_RECEIVED,t)
try{for(var o=ce(e),a=o.next();!a.done;a=o.next()){a.value.postMessage(i)}}catch(e){n={error:e}}finally{try{a&&!a.done&&(r=o.return)&&r.call(o)}finally{if(n)throw n.error}}}function ze(){return self.clients.matchAll({type:"window",includeUncontrolled:!0})}function Ke(e,t){return{firebaseMessaging:{type:e,payload:t}}}function Ve(e){var t,n=null!=(t=e.title)?t:"",r=e.actions,i=Notification.maxActions
...
var qe=function(){function e(t){i()(this,e),this.id=t}return a()(e,[{key:"getId",value:function(){return this.id}},{key:"isValid",value:function(){return!!this.id}}]),e}(),He=function e(t,n){i()(this,e),this.expire=(new Date).getTime()+1e3*n,this.item=t},Ge=function(){function e(t){i()(this,e),this.cachePrefix="pushDelivery.cache.",this.dbConfig=t.app.database,this.localStorageConfiguration=t.app.localStorage}return a()(e,[{key:"storeItemLocalStorage",value:function(e,t){localStorage.setItem(e,JSON.stringify(t))}},{key:"getItemLocalStorage",value:function(e){return JSON.parse(localStorage.getItem(e))}},{key:"removeItemLocalStorage",value:function(e){localStorage.removeItem(e)}},{key:"init",value:function(){if(window.indexedDB){var e=indexedDB.open(this.dbConfig.notificationDB,this.dbConfig.version),t=this.dbConfig,n=this
...
t&&o.length<=i?(o.push(t.value),t.continue()):n(o)},a.onerror=r}))}},{key:"addCache",value:function(e,t,n){sessionStorage.setItem(this.cachePrefix+e,JSON.stringify(new He(t,n)))}},{key:"getCache",value:function(e){var t=sessionStorage.getItem(this.cachePrefix+e)
...
t[i]instanceof Object&&Object.assign(t[i],Je(e[i],t[i]))}return Object.assign(e||{},t),e}function $e(e){var t=[],n=!0,r=!1,i=void 0
...
return this.messaging.getToken().then((function(t){var n=new qe
...
return new qe(e?e.id:null)}},{key:"subscribeToDefaultTags",value:function(){var e=this
...
if(this.config.app.client.defaultSubscribedTags){if("function"==typeof this.config.app.client.defaultSubscribedTags)return this.getTags().then((function(t){return e.config.app.client.defaultSubscribedTags(t)}))
...
return new Promise((function(n,r){if("string"==typeof e)t.getTags().then((function(t){var r=$e(t)[0].tags.filter((function(t){return t.sourceId===e}))[0].id
n(r)}))
...
e.showOnSiteNotification(i)}catch(e){console.log("failed",e)}})),this.pushDelivery.init(),this.deniedDialog=new st(this.config),"bluewin"===this.config.app.client.defaultSubscribedTags[0]&&this.bluewinTags(),this.config.app.client.autosubscribe?this.onLoadInit(this.config):(this.createSettingsButton(this.config),this.createSidebarPanel(),this.updateButtonLabel(),Ye(this.settingsButtonId,"flex"))}},{key:"bluewinTags",value:function(){var e=this
...
e.forEach((function(e){e.tags.forEach((function(e){(e.sourceId.includes("breakingnews")||e.sourceId.includes("sports")||e.sourceId.includes("bigstories"))&&t.push(e)}))})),t.forEach((function(e){return r.push(e.id)}))},u=n[Symbol.iterator]();!(i=(s=u.next()).done);i=!0)c()}catch(e){o=!0,a=e}finally{try{i||null==u.return||u.return()}finally{if(o)throw a}}return r}(t)
...
var n,r=this
return document.getElementById(this.showArchiveButtonId).addEventListener("click",(function(){Xe(r.settingsPanelId),Ye(r.archivePanelId),this.className="pushdelivery__tab__msg active",document.getElementById(r.showSettingsButtonId).className="pushdelivery__tab__settings"})),document.getElementById(this.showSettingsButtonId).addEventListener("click",(function(){Ye(r.settingsPanelId),Xe(r.archivePanelId),this.className="pushdelivery__tab__settings active",document.getElementById(r.showArchiveButtonId).className="pushdelivery__tab__msg"})),document.getElementById("pushdelivery__sidebar--close").addEventListener("click",(n=this,function(){Xe(n.sidebarId)})),Xe(this.settingsPanelId),this.createSubscriptionView()}},{key:"createSubscriptionView",value:function(){var e=this
return this.pushDelivery.getTags().then((function(t){if(!e.config.app.client.autosubscribe){var n=$e(t)
...
f.className="pushdelivery__sidebarsettings__cancel",f.textContent=this.translationService.getLabel(this.language,"sidebar","button_unsubscribe"),f.addEventListener("click",(function(){return n.cancelAllSubscriptions()})),l.appendChild(f)
...
this.confirmUnsubscribeWindow()&&(this.pushDelivery.getSubscribedTags().then((function(t){e.pushDelivery.unsubscribeFrom(t.map((function(e){return e.id}))).then((function(){e.updateButtonLabel()}))})),Xe(this.sidebarId))}},{key:"confirmUnsubscribeWindow",value:function(){var e=this.translationService.getLabel(this.language,"confirm")
return window.confirm(e.label_text)}},{key:"getPushNotificationPermission",value:function(){return Notification.permission}},{key:"checkNotificationPermissions",value:(n=it()(nt.a.mark((function e(t){var n=this
return nt.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",new Promise(function(){var e=it()(nt.a.mark((function e(t,r){var i,o
return nt.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:if("default"!==(i=n.getPushNotificationPermission())){e.next=9
break}return o=new at(n.config),e.next=5,o.confirm()
...
case 1:case"end":return e.stop()}}),e)}))),function(e){return n.apply(this,arguments)})},{key:"requestUserPermission",value:(t=it()(nt.a.mark((function e(){var t=this
return nt.a.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",Notification.requestPermission().then((function(e){if("permission"in Notification||(Notification.permission=e),"granted"===Notification.permission)return new Promise((function(e,n){t.pushDelivery.getDevice().getId()?e():t.pushDelivery.retrieveAndStoreDeviceToken().then((function(){e()}))}))})))
case 1:case"end":return e.stop()}}),e)}))),function(){return t.apply(this,arguments)})},{key:"showSidebarArchive",value:function(e){Xe(this.settingsPanelId),this.updateSubscribedTagSelection(e),this.renderArchiveView(),Ye(this.archivePanelId),this.whichSidebarPanelRender(this,this.archivePanelId),Ye(this.sidebarId)}},{key:"showSidebarSettings",value:function(e){Xe(this.archivePanelId),this.updateSubscribedTagSelection(e),this.renderArchiveView(),Ye(this.settingsPanelId),this.whichSidebarPanelRender(this,this.settingsPanelId),Ye(this.sidebarId)}},{key:"onLoadInit",value:function(e){var t=this
this.checkNotificationPermissions(e).then((function(){return t.pushDelivery.subscribeToDefaultTags()}))}},{key:"settingsButtonHandler",value:function(e){var t=this
...
n(14)
window.PushDeliveryUI=ct,window.PushDelivery=et}])}))
